...
FILE: portfolio/app/Views/resume/index.php
DESCRIPTION: This is the resume page for my portfolio website
             that is housed at rikkitomikoehrhart.com and is 
             also on Github
-->
<div class="main">
    <!-- RESUME PAGE -->
    <div class="resume">
        ...
        <div class="workSection">
            ...
            <div class="resumeCard">
                ...
                <div>
                    <ul>
                        ...
                        <li>
                            Quickly adapts to new tasks with little to no supervision
                            or training.
                        </li>
                        <li>
                            Contacts local businesses to get quotes for event planning,
                            provide research on behalf of the clients, and record voice-
                            overs providing multiple takes for client to choose from.
                        </li>
                    </ul>
                </div>
            ...
            <div class="resumeCard">
                ...
                <div class="resumeEntry">
                    <h5>Casoro Group/Upside Avenue</h5>
                    <p>Austin, TX</p>
                </div>

                <div class="resumeEntry">
                    <p><i>Office Administrator</i></p>
                    <p>Feb 2020 - Apr 2023</p>
                </div>

                <div>
                    <ul>
                        <li>
                            Salesforce Administrator responsible for
                            permissions, automations, creating reports,
                            providing field management of custom fields,
            ...
            <div class="resumeCard">
                ...
                <div class="resumeEntry">
                    <p><i>Associate Team Leader</i></p>
                    <p>Apr 2012 - Jan 2020</p>
                </div>
                ...
                <div>
                    <em>Award</em>: <i>Bakery Regional All-Star, 2015</i> --
                    Our department was awarded the Regional All-Star Award
                    for our food safety and financials, which I was directly
                    responsible for.
                </div>

                <div>
                    <em>Award</em>: <i>Outstanding Team Member, 2013</i> --
                    I received this award from my sales initiatives for the
                    Bakery Department which resulted in regional recognition
                </div>
